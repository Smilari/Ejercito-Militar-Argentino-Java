...
public class Consola {
	...
	/**
     * Muestra al usuario un mensaje y luego retorna un valor Booleano, 
	 * dependiendo la entrada del usuario (S/N).
     *
     * @param mensaje El mensaje que el usuario verá antes de ingresar un valor.
